			...
			<div className="flex flex-col gap-8 mb-4 md:px-28 px-10 container">
				...
				<div className="align-bottom flex flex-row">
					<div className="text-neutral-500 grow">
						© 2026 Buape Studios LLC. All rights reserved.
					</div>
					<div className="flex flex-row gap-2">
						<a href="https://x.com/buapestudios">
							<FaXTwitter />
						</a>
						<a href="https://discord.gg/7MUYugRj2T">
							<BsDiscord />
						</a>
						<a href="https://github.com/buape">
							<FaGithub />
						</a>
					</div>
				</div>
	...
	return (
		<div className="flex flex-col gap-6 grow">
			...
			<div className="flex flex-col gap-4">
				{data.links.map((x) => (
					<a href={x.link} className="text-stone-300" key={x.link}>
						{x.text}
					</a>
				))}
			</div>
